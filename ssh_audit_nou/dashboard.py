...
if not os.path.exists(CSV_FILE):
    ...
    with right_column:
        ...
        with tab_iso:
            ...
            fig_roc_iso.update_layout(xaxis_title='False Positive Rate', yaxis_title='True Positive Rate', height=500, margin=dict(l=20, r=20, t=20, b=20), font=dict(size=14))
            st.plotly_chart(fig_roc_iso, width="stretch")
            ...
            fig_cm_iso.update_layout(coloraxis_showscale=False, height=500, font=dict(size=18))
            fig_cm_iso.update_traces(texttemplate="%{z:.0f}")
            st.plotly_chart(fig_cm_iso, width="stretch")
        ...
        with tab_svm:
            ...
            fig_roc_svm.update_layout(xaxis_title='False Positive Rate', yaxis_title='True Positive Rate', height=500, margin=dict(l=20, r=20, t=20, b=20), font=dict(size=14))
            st.plotly_chart(fig_roc_svm, width="stretch")
            ...
            fig_cm_svm.update_layout(coloraxis_showscale=False, height=500, font=dict(size=18))
            fig_cm_svm.update_traces(texttemplate="%{z:.0f}")
        ...
        with tab_lof:
            ...
            fig_roc_lof.update_layout(xaxis_title='False Positive Rate', yaxis_title='True Positive Rate', height=500, margin=dict(l=20, r=20, t=20, b=20), font=dict(size=14))
            st.plotly_chart(fig_roc_lof, width="stretch")
            ...
            fig_cm_lof.update_layout(coloraxis_showscale=False, height=500, font=dict(size=18))
            fig_cm_lof.update_traces(texttemplate="%{z:.0f}")
            st.plotly_chart(fig_cm_lof, width="stretch")
