...
if not os.path.exists(CSV_FILE):
    ...
    with right_column:
        ...
        with tab_iso:
            ...
            fig_cm_iso.update_traces(texttemplate="<b>%{z:.0f}</b>", textfont_size=28)
            st.plotly_chart(fig_cm_iso)
        ...
        with tab_svm:
            ...
            fig_cm_svm.update_traces(texttemplate="<b>%{z:.0f}</b>", textfont_size=28)
        ...
        with tab_lof:
            ...
            fig_cm_lof.update_traces(texttemplate="<b>%{z:.0f}</b>", textfont_size=28)
            st.plotly_chart(fig_cm_lof)